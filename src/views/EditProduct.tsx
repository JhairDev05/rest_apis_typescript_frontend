...
export async function loader({ params }: LoaderFunctionArgs) {
    if (params.id !== undefined) { // Primero comprobamos que no sea undefined
        const product = await getProductById(+params.id) // + Luego lo pasamos a número porque viene como string
        if (!product) {
